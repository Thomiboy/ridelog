...
- **Phase 3 (planned):**
  ...
  - **MapLibre** — swap the map engine behind the existing map component seam
...
- **Backlog:** containerization (Container Apps), Azure Blob Storage for raw files — both deferred while the zero-cost hosting setup is working
