...
public class TcxActivityParserTests
{
    ...
    [Fact]
    public void Exposes_the_lap_maximum_as_the_device_summary()
    {
        // Lap MaximumSpeed is metres per second; 16.5 m/s × 3.6 = 59.4 km/h. The parser reports what
        // the file says and nothing more — deciding the ride's top speed is the caller's job, from
        // the route it stores (docs/adr/0002).
        Assert.Equal(59.4, Parse().DeviceMaximumSpeedKmh!.Value, 0.01);
    }
